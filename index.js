...
HEADERS.responseCode['X-Powered-By'] = 'BWNode.js';
HEADERS.redirect = {};
...
HEADERS.sse['X-Powered-By'] = 'BWNode.js';
HEADERS.mmr = {};
...
HEADERS.file_lastmodified['X-Powered-By'] = 'BWNode.js';
...
HEADERS.file_release_compress['X-Powered-By'] = 'BWNode.js';
...
HEADERS.file_release_compress_range['X-Powered-By'] = 'BWNode.js';
...
HEADERS.file_release['X-Powered-By'] = 'BWNode.js';
...
HEADERS.file_release_range['X-Powered-By'] = 'BWNode.js';
...
HEADERS.file_debug_compress['X-Powered-By'] = 'BWNode.js';
...
HEADERS.file_debug_compress_range['X-Powered-By'] = 'BWNode.js';
HEADERS.file_debug = {};
...
HEADERS.file_debug['X-Powered-By'] = 'BWNode.js';
...
HEADERS.file_debug_range['X-Powered-By'] = 'BWNode.js';
...
HEADERS.content_mobile['X-Powered-By'] = 'BWNode.js';
...
HEADERS.content_compress['X-Powered-By'] = 'BWNode.js';
HEADERS.content = {};
HEADERS.content['Vary'] = 'Accept-Encoding';
HEADERS.content['X-Powered-By'] = 'BWNode.js';
...
HEADERS.stream_release_compress['X-Powered-By'] = 'BWNode.js';
...
HEADERS.stream_release['X-Powered-By'] = 'BWNode.js';
...
HEADERS.stream_debug_compress['X-Powered-By'] = 'BWNode.js';
...
HEADERS.responseNotModified['X-Powered-By'] = 'BWNode.js';
HEADERS.response503 = {};
HEADERS.response503[HEADER_CACHE] = 'private, no-cache, no-store, must-revalidate';
HEADERS.response503[HEADER_TYPE] = CT_HTML;
HEADERS.response503['X-Powered-By'] = 'BWNode.js';
HEADERS.notModifiedEtag = {};
HEADERS.notModifiedEtag['X-Powered-By'] = 'BWNode.js';
HEADERS.notModifiedLastModifiedDate = {};
HEADERS.notModifiedLastModifiedDate['X-Powered-By'] = 'BWNode.js';
...
F.load = function(debug, types, pwd) {
	...
	F.$startup(function() {
		...
		F.$load(types, directory, function() {
			...
			F.isLoaded = true;
			process.send && process.send('bwnode:ready');
...
F.initialize = function(http, debug, options, restart) {
	...
	if (!F.config['directory-temp'])
		F.config['directory-temp'] = '~' + U.path(Path.join(Os.tmpdir(), 'bwnode' + F.directory.hash()));
...
F.console = function() {
	...
	console.log('BWNode.js    : v' + F.version_header);
...
F.$configure_configs = function(arr, rewrite) {
	...
	var done = function() {
		process.title = 'bwnode: ' + F.config.name.removeDiacritics().toLowerCase().replace(REG_EMPTY, '-').substring(0, 8);
...
Controller.prototype.mmr = function(name, stream, callback) {
	...
	if (!self.type) {
		self.type = 2;
		self.boundary = '----bwnode' + U.GUID(10);
		self.req.$total_success();
		self.req.on('close', () => self.close());
		res.success = true;
...
process.on('uncaughtException', function(e) {
	...
	if (err.indexOf('listen EADDRINUSE') !== -1) {
		process.send && process.send('bwnode:eaddrinuse');
...
function parseComponent(body, filename) {
	...
	while (true) {
		beg = body.indexOf('<script type="text/bwnode">');
		if (beg === -1)
			break;
